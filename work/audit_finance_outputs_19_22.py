...
for episode in (19, 20, 21, 22):
    ...
    print(f"EP{episode}\theadings={len(headings)}\tlists={len(lists)}\ttables={len(doc.tables)}\tsheets={len(content)}")
